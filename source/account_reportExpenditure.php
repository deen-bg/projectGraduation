...
require_once("../Project/mpdf_mpdf_7.1.5.0_require/vendor/autoload.php");	//require mPDF file//
	...
	$sql = "SELECT * FROM account WHERE account_itemtype='รายจ่าย'";		//Select table
	$stmt = $db->prepare($sql);
...
////////////////////////////////mPDF run class/////////////////////////////////////////
	...
	$mpdf->WriteHTML('<h3 style="text-align: center">ข้อมูลรายจ่าย</h3></center>');	//write topic//
	...
	$mpdf->WriteHTML('<b>สรุปรายจ่าย : </b>'.$total.'&nbsp;<b>บาท');
	$mpdf->WriteHTML("<hr>");
//////////////////////////////footer//////////////////////////////////////
/*::footer details
	-Day-month-year
